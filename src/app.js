...
export class App {
  ...
  configureRouter(config, router) {
    ...
    config.map([
      {route: '', name: 'index', moduleId: PLATFORM.moduleName('./views/order-views/index'), title: 'Orders', settings: {data: 'home'}},
      ...
      {route: 'orders', name: 'orders', moduleId: PLATFORM.moduleName('./views/order-views/orders'), title: 'Completed orders', settings: {data: 'box icon'}},
